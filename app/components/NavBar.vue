...
<template>
  ...
  >
    ...
    <ClientOnly>
      <li>
        <button
          class="cursor-pointer duration-200 rounded-full p-1.5 sm:p-2 lg:p-2.5 flex items-center justify-center transition-all"
          :class="buttonClass"
      ...
      <template #fallback>
        <li>
          <button
            class="rounded-full p-1.5 sm:p-2 lg:p-2.5 flex items-center justify-center cursor-progress"
            disabled
